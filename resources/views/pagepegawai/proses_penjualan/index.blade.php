...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--breadcrumb-->
            <h6 class="mb-0 text-uppercase">PESANAN MASUK</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                                ...
                                @foreach ($checkoutData as $checkout)
                                    @if ($checkout['status'] == 'pending')
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('pesanan.dikirim', $checkout['id']) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="col-md-12">
                                                        <label for="no_resi" class="form-label">NO RESI</label>
                                                        <input type="text" class="form-control mb-2" id="no_resi"
                                                            name="no_resi" required>
                                                    </div>
                                                    <button type="submit" class="btn btn-outline-dark px-5">Kirim
                                                        Pesanan</button>
                                                </form>
                                            </td>
                                        </tr>
