                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Master Merk Barang</h5>
                            </div>
                            <hr>
                            <form action="{{ route('merk.update', $merk->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" required>{{ old('deskripsi', $merk->deskripsi) }}</textarea>
                                </div>
                                <!-- Logo -->
                                <div class="col-md-12 mb-3">
                                    ...
                                    @if(isset($merk->logo))
                                        <div class="mb-2">
                                            <img src="{{ asset($merk->logo) }}" alt="logo" class="img-thumbnail" width="100px" height="auto">
                                        </div>
                                    @endif
